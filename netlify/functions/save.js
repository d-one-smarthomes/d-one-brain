...
// Token stays server-side (Netlify env var). Optional shared-password gate via EDIT_PASSWORD.
export async function handler(event) {
  ...
  const gate  = process.env.EDIT_PASSWORD; // optional; if set, required to save
